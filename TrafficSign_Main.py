...
#                               steps_per_epoch=steps_per_epoch, epochs=epochs_val,
#                               validation_data=(X_validation, y_validation),validation_steps=validation_steps, shuffle=True)
history = model.fit(dataGen.flow(X_train, y_train, batch_size=batch_size_val),
                    steps_per_epoch=steps_per_epoch, 
                    epochs=epochs_val,
                    validation_data=dataGen.flow(X_validation, y_validation),  # Use data augmentation for validation
